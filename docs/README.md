...
> Auto-generated by Operon on 2026-02-27 23:10
...
```json
{
  "project_description": "Operon is an advanced AI software project designed to enhance file management and automation. It includes components for approval, decision-making, and interaction with large language models (LLMs).",
  "main_components": {
    "agent/approval.py": "Handles the approval process for filesystem mutations. Ensures that changes are validated, logged, and timeout-safe.",
    "agent/decide.py": "Deterministic-first approach to deciding whether to apply changes. Reads files directly from disk, checks for changes, and uses LLMs for goal-satisfaction checks.",
    "agent/llm.py": "Manages interactions with various LLMs, providing a unified interface for different models. Ensures that file content is not trimmed during editing to maintain context."
  }
}
```
...
| [`docs/modules/print.java`](modules/docs_modules_print.java) | (empty) |
| [`docs/modules/print.js`](modules/docs_modules_print.js) | (empty) |
